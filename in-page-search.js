(function () {
  ...
  // with a target string identifying ONE specific occurrence, built
  // from that occurrence's matched text plus the two words after it
  // (see index.htm's buildFragmentText). These helpers rebuild the
  // same "matched text + two following words" string for each
  // highlighted match here, so the one the link actually pointed at
  // can be found and jumped to.
  //
