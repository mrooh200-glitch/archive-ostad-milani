(function () {
  ...
  function createSearchBox() {
    ...
    // Item جدید: وقتی این صفحه داخل یک iframe باز شده (مثلاً در نمای
    // «مطالعهٔ کنار هم» در index.htm)، عنوان کتاب از قبل در یک کادر
    // بیرون از iframe نمایش داده می‌شود - تکرارش این‌جا فقط شلوغی
    // اضافه می‌کند.
    ...
    box.innerHTML = `
      <div class="in-page-search-row">
        ${isEmbedded ? "" : `<span id="inPageSearchTitle">${getPageTitle()}</span>`}
