(function () {
  ...
  function showMatch(index) {
    ...
    // Item جدید (رفع اشکال): "smooth" حذف شد - انیمیشن‌های اسکرول نرم
    // گاهی با یک reflow/اسکرول رقیب بلافاصله بعدشان (مثلاً تغییر
    // کلاس‌های موجود در همین تابع) بی‌صدا لغو می‌شوند، به‌خصوص داخل
    // iframeهای نمای «مطالعهٔ کنار هم». "auto" فوری و قابل‌اطمینان است.
